...
Status: documentation changes await review. NUnit is confirmed within ADR-0001; its remaining stack proposals and ADR-0002 await confirmation. ADR-0003 records the confirmed dependency injection direction. No code scaffolding is authorized by this step.
